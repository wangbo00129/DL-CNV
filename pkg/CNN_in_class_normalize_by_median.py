...
class DataSet(object):
    ...
    def readBatch(self, batch_num=10,shuffle=False):
        ...
        for _ in range(batch_num):
            ...
            if DO_NORMALIZE:
                current_mat = current_mat/np.median(np.array(current_mat))
...
class CNNClass(object):
    ...
    def __init__(self, size_conv1, size_conv2):
        ...
        save_sess_path='d:\\eclipse-workspace\\CNN_CNV\\new_save_sess_stride_conv_size_'+str(size_conv1)+'_'+str(size_conv2)+'\\'
