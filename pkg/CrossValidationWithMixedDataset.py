...
#                   os.path.join(data_set_parent, 'TwoCNN_over_sampling_'+str(keep_probability)+'_normalize_by_max_fill_by_0_stride_40_'+iname+'_as_test_'), '1'))
        ...
        model_dir = os.path.join(data_set_parent, 'Strong_positive_simpler_over_sampling_0.5_normalize_by_file_size_fill_by_0_stride_40_part_0_as_test_')
...
if __name__ == '__main__':
    ...
    input_dir = 'D:/eclipse-workspace/CNN_CNV/data_bigger_training_added_strong_positive_stride_25/mixed'
    input_dir = r'D:\eclipse-workspace\CNN_CNV\data_bigger_training_added_strong_positive_stride_40\\'
    #for i in range(9, 10):
    generate_fake = False
    for i in range(6,7):
