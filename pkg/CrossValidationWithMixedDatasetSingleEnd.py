...
#                   os.path.join(data_set_parent, 'TwoCNN_over_sampling_'+str(keep_probability)+'_normalize_by_max_fill_by_0_stride_40_'+iname+'_as_test_'), '1'))
        ...
        model_dir = os.path.join(data_set_parent, prefix_useTwoLayers+'_kernel_'+
                                 str(keep_probability)+'_normalizebymean_fillby0_stride25_'+iname+'_as_test_')
...
#                 model_dir, None)
        ...
        path_testing = "D:/eclipse-workspace/CNN_CNV/data_single_end_model/producing_1056"
        CNNClass(path_training, path_testing, 21, 62, kernel1size, kernel2size, 1e-5, 0, 
...
if __name__ == '__main__':
    ...
    input_dir = 'D:/eclipse-workspace/CNN_CNV/data_bigger_training_added_strong_positive_stride_25/mixed'
    input_dir = 'D:/eclipse-workspace/CNN_CNV/data_single_end_model_76/mixed_stride40'
    #input_dir = 'D:/eclipse-workspace/CNN_CNV/data_single_end_model/mixed_stride40'
    #for i in range(9, 10):
    generate_fake = False
    for i in range(10):
        output_dir = os.path.join(os.path.dirname(input_dir), '5xCV_data_rand_'+str(i))
