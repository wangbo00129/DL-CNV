...
#                   os.path.join(data_set_parent, 'TwoCNN_over_sampling_'+str(keep_probability)+'_normalize_by_max_fill_by_0_stride_40_'+iname+'_as_test_'), '1'))
        ...
        model_dir = os.path.join(data_set_parent, prefix_useTwoLayers+'_kernel_'+
                                 str(keep_probability)+'_oversamp1_20fold_normalizebymean_fillby0_stride25_'+iname+'_as_test_')
...
#                 model_dir, None)
        ...
        CNNClass(path_training, path_testing, 21, 62, kernel1size, kernel2size, 1e-5, 10000, 
                 useTwoLayers, mean, zero, keep_probability, model_dir, '1')
